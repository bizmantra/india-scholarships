...
export default function ScholarshipDetail({ params }: { params: { slug: string } }) {
    const scholarship = MOCK_SCHOLARSHIPS.find(s => s.sc_slug === params.slug);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-2xl border p-6 md:p-8 shadow-sm">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <div className="flex gap-2">
                                <button className="p-3 border rounded-xl hover:bg-muted transition-colors"><Bookmark className="h-5 w-5" /></button>
                                <button className="p-3 border rounded-xl hover:bg-muted transition-colors"><Share2 className="h-5 w-5" /></button>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-primary text-primary-foreground rounded-2xl p-6 shadow-xl shadow-primary/20">
                        <h3 className="font-bold mb-4 font-outfit flex items-center gap-2 text-sm uppercase tracking-wider uppercase">
