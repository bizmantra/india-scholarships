...
![Tools Hub Screenshot](./screenshots/tools_hub.png)

*   **SEO Audit**:
    *   *Unique Title*: Yes ("Free Scholarship Tools & Calculators for Indian Students")
    *   *Meta Description*: Yes (Free suite of calculators, estimators, converters)
    *   *H1/H2*: Yes
...
![Eligibility Checker Screenshot](./screenshots/eligibility_checker.png)
...
![CGPA Converter Screenshot](./screenshots/cgpa_converter.png)
...
![Family Income Calculator Screenshot](./screenshots/income_calculator.png)
...
![Amount Calculator Screenshot](./screenshots/amount_calculator.png)
...
![Study Cost Calculator Screenshot](./screenshots/study_cost_calculator.png)
...
![EMI Calculator Screenshot](./screenshots/loan_emi_calculator.png)
...
![Finder Wizard Screenshot](./screenshots/finder_wizard.png)
...
![Compare Tool Screenshot](./screenshots/compare.png)
