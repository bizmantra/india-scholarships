# 📰 Editorial Articles Backlog (data/backlog-articles.json)
...
| ART-68 | Reliance Foundation Undergraduate Scholarship: How to Win | `reliance-foundation-undergraduate-scholarship` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-69 | HDFC Bank Parivartan ECSS Scholarship: Eligibility & Selection | `hdfc-badhte-kadam-scholarship-guide` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-70 | Sitaram Jindal Foundation Scholarship: Annexure & Offline Form Guide | `sitaram-jindal-foundation-scholarship` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-71 | Kotak Kanya Scholarship for Female Engineers: Step-by-Step | `kotak-kanya-scholarship-guide` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-72 | Aditya Birla Capital Scholarship: Application Guide & Last Date | `aditya-birla-capital-scholarship` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-73 | SBI Foundation ASHA Scholarship: Registration & Selection Process | `sbif-asha-scholarship-guide` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-74 | Colgate Keep India Smiling Scholarship: How to Fill Form | `keep-india-smiling-foundational-scholarship` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-75 | Buddy4Study vs Govt Portals: How to Safely Apply to Private Grants | `buddy4study-vs-indiascholarships-guide` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-76 | Fast Disbursing Scholarships: Private Grants That Pay Within 60 Days | `fastest-disbursing-private-scholarships` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-77 | How to Clear Telephonic Interviews for Private CSR Scholarships | `interview-tips-for-corporate-scholarships` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-78 | How to Write a Winning Statement of Purpose for Scholarships | `essay-writing-tips-for-scholarships` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-79 | Scholarships For Students With 50% - 60% Marks (Low Academic Requirement) | `scholarships-without-minimum-marks` | Pillar 4: Corporate & CSR | `/tools/eligibility-checker` | Backlog |
| ART-80 | How to Renew Corporate Scholarships Year After Year | `renewing-private-csr-scholarships` | Pillar 4: Corporate & CSR | `/corporate-scholarships` | Backlog |
| ART-81 | How to Apply for Income Certificate Online in 10 Indian States | `how-to-make-income-certificate-online` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-82 | How to Check NPCI Aadhaar Bank Seeding Status on UIDAI Portal | `npci-aadhaar-bank-seeding-check` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-83 | Download Free Bonafide Certificate Format for College Scholarship | `bonafide-certificate-scholarship-format` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-84 | Can You Apply for 2 Scholarships at the Same Time? Official Govt Rules | `can-you-apply-for-two-scholarships` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-85 | NSP Application Pending at School/Institute: How to Get it Verified | `nsp-application-pending-at-institute-fix` | Pillar 5: Procedural & Docs | `/guides/nsp/status-check` | Backlog |
| ART-86 | How to Correct Defect Status in NSP & Re-upload Wrong Documents | `nsp-defect-status-re-upload-guide` | Pillar 5: Procedural & Docs | `/guides/nsp/documents-list` | Backlog |
...
| ART-94 | Hostel Warden Certificate Format for Maintenance Allowance Claim | `hostel-certificate-format-scholarship` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-95 | How to Track Scholarship Money Disbursed on PFMS Portal | `how-to-check-pfms-know-your-payment` | Pillar 5: Procedural & Docs | `/guides/pfms` | Backlog |
| ART-96 | How to Identify Fake Scholarship Portals & Avoid Scam Fees | `scholarship-scam-warning-fake-portals` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-97 | Do Students Have to Pay Income Tax on Scholarship Money in India? | `income-tax-on-scholarship-money-rules` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-98 | Aadhaar Name Different From Marksheet? How to Fix Verification Error | `aadhaar-name-mismatch-in-marksheet` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
| ART-99 | How to Convert Fresh NSP Application to Renewal Application | `how-to-renew-nsp-scholarship-online` | Pillar 5: Procedural & Docs | `/guides/nsp` | Backlog |
| ART-100 | How to Compress PDF Documents Under 200KB for Govt Portals | `scholarship-document-scanner-size-guide` | Pillar 5: Procedural & Docs | `/tools/eligibility-checker` | Backlog |
