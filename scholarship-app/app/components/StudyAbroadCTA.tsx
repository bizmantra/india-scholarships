...
export default function StudyAbroadCTA() {
  return (
    <div className="my-10 overflow-hidden rounded-2xl border border-indigo-100 bg-gradient-to-br from-slate-900 via-slate-950 to-indigo-950 p-6 md:p-8 text-white shadow-lg relative group">
      {/* Decorative glowing background gradients */}
      <div className="absolute -right-16 -top-16 w-36 h-36 rounded-full bg-indigo-500/10 blur-2xl group-hover:bg-indigo-500/20 transition-all duration-500"></div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
        <div className="flex-1 space-y-3">
          ...
          <p className="text-sm text-slate-300 leading-relaxed max-w-2xl font-medium">
            Calculate your costs, compare non-collateral loans, and get step-by-step visa checklists with our zero-gating <span className="text-indigo-300 font-bold">Study Abroad Decision Engine</span>.
          </p>
        </div>
