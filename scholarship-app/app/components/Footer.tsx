                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="https://study.indiascholarships.in" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 font-extrabold transition-colors flex items-center gap-1">Study Abroad Portal 🌍</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link href="/guides" className="hover:text-white transition-colors">Scholarship Guides</Link></li>
                            <li><Link href="/eligibility-checker" className="hover:text-white transition-colors">Eligibility Checker</Link></li>
                            <li><Link href="/guides/india-scholarships-statistics-2025-2026" className="hover:text-white transition-colors font-bold text-google-green">📊 Scholarship Stats (2025-26)</Link></li>
