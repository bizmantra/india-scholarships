import { getRecentlyAddedScholarships } from '@/lib/db';
                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 md:p-12 mb-12 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="max-w-2xl">
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-bold mb-4 border border-blue-100">
                                <Clock className="h-3.5 w-3.5" /> Just Added
                            </div>
                            <h1 className="text-3xl md:text-5xl font-black text-gray-900 font-serif mb-4 leading-tight tracking-tight">
                                New Scholarships ({currentMonth} {currentYear})
                            </h1>
                            <p className="text-gray-600 text-lg leading-relaxed font-medium">
                                The latest financial aid opportunities, private CSR schemes, and state/national portals verified by our research team. Apply today before slots fill up.
                            </p>
                        </div>
                        <div className="bg-blue-50/50 border border-blue-100/50 p-6 rounded-3xl text-center shrink-0 md:w-48">
                            <span className="text-4xl font-black text-blue-700 block mb-1">{scholarships.length}</span>
                            <span className="text-xs font-bold text-blue-900 uppercase tracking-wider">Recently Added</span>
                        </div>
                    </div>
                    ...
                    {scholarships.length === 0 ? (
                        <div className="text-center py-20 bg-white border border-gray-100 rounded-[2.5rem]">
                            <p className="text-gray-500 text-lg font-medium mb-4">No recently added scholarships found.</p>
